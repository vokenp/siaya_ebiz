		    ...
		    <div class="row">
			   ...
			   <div class="row">
			   	<div class="form-group col-sm-5">
						...
						<div class="col-sm-8">
							<select  id="IconRef" name="IconRef" placeholder="Enter Icon Ref" class="chosen-select col-xs-10 col-sm-10"   required="true">
								<?php echo $rs->GetListItems($rst["IconRef"],"FontAwesome","edit");?>
