...
<script type="text/javascript">
	$(document).ready(function(){
		var op = $("#op").val();
         if (op == "edit") 
         {
         	$("#PersonnelNo").prop("disabled",true);
         }
            ...
            <?php echo $S_ROWID;?>
							  	  <div class="row">
					             	<div class="form-group col-sm-6">
										<label class="col-sm-3 control-label " for="PersonnelNo"> PFNo/IDNo </label>
										<div class="col-sm-9">
						...
						<div class="col-sm-8">
							<dl id="dt-list-1" >
								...
								$PersonnelNo = $rst["PersonnelNo"];
									$getComm = $db->Execute("select *from vw_commMemberList where PersonnelNo='$PersonnelNo'");
									$html = "";
									while (!$getComm->EOF) {
										$rst = array();
										$rst = $getComm->fields;
