...
ini_set('display_errors', 1);
   ...
   while (!$getConf->EOF) {
    ...
    $html .= "<label class='col-sm-4 control-label' for='Venue'>$AttribLabel</label>";
   ...
   $html .="<div class='row'><button type='submit' name='btnSaveRecord' id='btnSaveRecord'  value='$ConfType' class='button'>Update Settings</button></div>";
