...
<script type="text/javascript">
	$(document).ready(function(){
    	...
    	{
          $("#CommitteeName").attr("readonly",true);
  ...
  var comMemberTable = $('#tblMemberList').DataTable({
       ...
       dom: 'Blfrtip',
        ...
        "fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
                    if ( aData[3] == "ChairPerson" )
                    {
                        $('td', nRow).css('background-color', 'Orange');
                        $('td', nRow).css('font-weight', 'bold');
                    }
                    else if ( aData[3] == "Vice ChairPerson" )
                    {
           ...
           <div class="widget-main">
        	  <div class="row">
                 	<div class="form-group col-sm-7">
						...
						<div class="col-sm-8">
							<input type="text" id="CommitteeName" name="CommitteeName" placeholder="Enter Committee Name" class="col-xs-11 col-sm-11" value="<?php echo $rst['CommitteeName'];?>"  required="true" />
						</div>
					</div>
